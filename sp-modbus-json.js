...
function device_to_config(config){
    switch (config.device) {
        ...
        case "ecu_c_v101": config.json = require('./config_json/ecu_c_v101.json'); break;
        case "ecu_c_v111": config.json = require('./config_json/ecu_c_v111.json'); break;
		case "ecu_c_v123": config.json = require('./config_json/ecu_c_v123.json'); break;
        case "user_1": config.json = require('./config_json/user_1.json'); break;
        case "user_2": config.json = require('./config_json/user_2.json'); break;
		case "user_3": config.json = require('./config_json/user_3.json'); break;
...
module.exports = function(RED) {
    ...
    RED.nodes.registerType("sp-modbus",start_node);
}
